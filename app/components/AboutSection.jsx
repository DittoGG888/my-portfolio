...
function AboutSection() {
  return (
    <div className="text-center py-16 text-[#ffffff]" id="about">
      <div className="container mx-auto px-6 relative">
        ...
        <div className="hidden md:block absolute left-1/2 h-full bg-[#F05F00] w-1 transform -translate-x-1/2 rounded-full">
          <div className="absolute top-[5%] left-1/2 transform -translate-x-1/2 w-4 h-4 bg-red-300 rounded-full"></div>
          <div className="absolute top-[35%] left-1/2 transform -translate-x-1/2 w-4 h-4 bg-red-300 rounded-full"></div>
          <div className="absolute top-[75%] left-1/2 transform -translate-x-1/2 w-4 h-4 bg-red-300 rounded-full"></div>
        </div>
        ...
        <div className="hidden md:grid grid-cols-1 grid-cols-2 gap-6 md:gap-8">
          ...
          <div className="grid grid-rows-4 gap-6 md:gap-8">
            {/* Education */}
            <div className="p-4 bg-[#F05F00]/30 rounded-lg shadow-sm backdrop-blur-sm">
              <h1 className="text-3xl md:text-4xl font-semibold mb-2 text-center">Education</h1>
            </div>

            {/* Web Development */}
            <div className="p-4 bg-[#F05F00]/30 rounded-lg shadow-sm">
          ...
          <div className="hidden md:grid md:grid-rows-4 gap-8">
            ...
            <div className="p-4 bg-[#F05F00]/30 rounded-lg shadow-sm">
              ...
              <p className="text-sm text-white-600">2022-2025</p>
              <p className="text-sm text-white-700">
            ...
            <div className="p-4 text-2xl text-center bg-[#F05F00]/30 rounded-lg shadow-sm">
          ...
          <div className="md:hidden grid grid-rows-4 gap-6">
            ...
            <div className="p-4 text-xl text-center bg-[#F05F00]/30 rounded-lg shadow-sm">
              <p>YouTube, Gaming & Friends</p>
              <p className="text-sm text-white-700">
                When I'm not coding, you'll find me with a joypad in my hand,
                unwinding with YouTube, or hanging with the boys!
